	...
	<div class="container">	
		...
		<div class="background">
			...
			<div id="loginContainer">
				...
				<!-- Content here -->
					<div id="loginText">
						<h1>Exprience great learning</h1>
						<h2>Live Online Financial Literacy Classes</h2>
						<ul>
							<li>Claim great discount!!</li>
							<li>Workshops and 1:1 Foundation Program</li>
